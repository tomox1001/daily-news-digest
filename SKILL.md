...
|---|-----------|----------|---------|-------------|------|
| 1 | X(Twitter)で話題 — AI・テック最新バズ | 2-3 | 🔥 | gradient-4 | 毎日 |
| 2 | Google Trends 急上昇 — AIキーワード速報 | 1-2 | 📈 | gradient-1 | 毎日 |
| 3 | YouTube AI動画 — 海外テック深掘り | 1 | ▶️ | gradient-3 | 毎日 |
| 4 | 中国SNSトレンド — 36Kr / 虎嗅 | 1-2 | 🇨🇳 | gradient-2 | 毎日 |
| 5 | AI効率 → ビジネス価値変換 グローバル事例 | 2 | 💡 | gradient-3 | 毎日 |
| 6 | AI RPO — アウトソーシング革命 | 2 | 🏭 | gradient-2 | 毎日 |
...
| AI RPO市場 | $49.6B ▲CAGR 34.3% | ダイジェストのテーマに直結する市場規模 |
